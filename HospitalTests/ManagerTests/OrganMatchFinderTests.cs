...
namespace HospitalTests.ManagerTests
{
	...
	public class OrganMatchFinderTests
	{
		...
		[TestCase(1, 1, true, "2011-04-16", 10, "O", "A", false)]
		[TestCase(1, 1, true, "2011-04-16", 10, "O", "B", false)]
		[TestCase(1, 1, true, "2011-04-16", 10, "O", "AB", false)]
		[TestCase(1, 1, true, "2011-04-16", 10, "A", "AB", false)]
		[TestCase(1, 1, true, "2011-04-16", 10, "B", "A", false)]
		[TestCase(1, 1, true, "2011-04-16", 10, "B", "AB", false)]
		...
		[TestCase(1, 1, true, "2020-02-10", 0, "AB", "A", true)]
		[TestCase(1, 1, true, "2020-06-23", 1, "AB", "A", true)]
		[TestCase(1, 1, true, "2018-09-01", 3, "AB", "A", true)]
		[TestCase(1, 1, true, "2017-10-07", 5, "AB", "A", true)]
		[TestCase(1, 1, true, "2010-06-10", 12, "AB", "A", true)]
		[TestCase(1, 1, true, "2003-03-27", 19, "AB", "A", true)]
		[TestCase(1, 1, true, "1986-02-03", 20, "AB", "A", true)]
		[TestCase(1, 1, true, "1919-09-03", 99, "AB", "A", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "O", "O", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "A", "O", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "B", "O", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "AB", "O", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "A", "A", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "B", "B", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "AB", "B", true)]
		[TestCase(1, 1, false, "2011-04-16", 90, "AB", "AB", true)]
